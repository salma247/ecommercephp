...
$select = "SELECT * from products WHERE categoryID = 6";
...
<div class="container my-3 px-0">
  <div class="row ">
    ...
    ?>
      ...
      <div class="card card-1 col-md-3 col-6 px-0 box" data-aos="fade-up">
        <a href="/ecommerce/ecommerceCustomer/orders/add.php?pID=<?php echo $row['id'] ?>" class="product-info">
          <form method="POST" class="rounded-circle">
            <button class="btn" name="wish" type="submit"><img src="https://img.icons8.com/material-outlined/24/fa314a/like--v1.png" /></button>
          </form>
          <img src="/ecommerce/products/upload/<?php echo $row['img1'] ?>" class="img-fluid m-0" alt="...">
